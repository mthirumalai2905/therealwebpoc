  ...
  return (
    <main className="bg-[var(--bg)] text-[var(--text)]">
      <section className="relative min-h-[100svh] overflow-hidden">
        ...
        <div className="relative z-10 mx-auto flex min-h-[100svh] max-w-[820px] flex-col items-center px-5 pt-28 text-center md:pt-32">
          <div className="flex max-h-[46svh] flex-col items-center">
